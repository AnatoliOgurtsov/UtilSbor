...
public class NavigationDrawerFragment extends Fragment {
     ...
     */
    public static interface NavigationDrawerClickListener {
        /**
    ...
    NavigationDrawerClickListener nav_dr_click_listener;
    ...
    OnClickListener ocltv = new OnClickListener(){
        @Override
        public void onClick(View v) {

            nav_dr_click_listener.onNavigationDrawerItemSelected((((TextView) v).getTag()).toString());
        }
    };
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            nav_dr_click_listener = (NavigationDrawerClickListener) activity;
